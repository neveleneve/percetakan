    ...
    <div class="col-12 col-lg-10">
        <ul class="nav nav-tabs justify-content-center">
            ...
            @if (Auth::user()->role->name == 'Admin')
                <li class="nav-item">
                    <a class="nav-link{{ Request::is('user*') ? ' active fw-bold' : ' text-dark' }}"
                        href="{{ route('user.index') }}">User</a>
                </li>
            @endif
            <li class="nav-item">
                <a class="nav-link{{ Request::is('gudang*') ? ' active fw-bold' : ' text-dark' }}"
            ...
            <li class="nav-item">
                <a class="nav-link{{ Request::is('laporan*') ? ' active fw-bold' : ' text-dark disabled' }}"
                    href="#">Laporan</a>
            </li>
        </ul>
    </div>
